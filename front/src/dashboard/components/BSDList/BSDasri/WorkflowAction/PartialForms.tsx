  ...
  return (
    <>
      <div className="form__row">
        <Field
          name="emitter.emission.wasteDetails.packagingInfos"
      ...
      <div className="form__row">
        <label>
          ...
          <Field
            type="text"
            name="emitter.emission.wasteDetails.adr"
            className="td-input"
          />
        </label>

        <RedErrorMessage name="emitter.emission.wasteDetails.onuCode" />
      </div>
    </>
  );
}
export function TransportSignatureForm() {
  return (
    <>
      ...
      <div className="form__row">
        <Field
          name="transporter.transport.wasteDetails.packagingInfos"
          component={Packagings}
        />
      </div>
...
export function ReceptionSignatureForm() {
  return (
    <>
      ...
      <div className="form__row">
        <Field
          name="destination.reception.wasteDetails.packagingInfos"
          component={Packagings}
        />
      </div>
    </>
